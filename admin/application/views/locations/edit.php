			...
			<div class="container-fluid">
				...
				<div class="breadcrumbs">
					<ul>
						...
						<li>
							<a href="<?php echo $this->config->base_url('locations');?>">Vehicle Locations</a>
							<i class="icon-angle-right"></i>
						</li>
                        <li>
							<a href="">Add New</a>
					...
					<div class="span12">
						<div class="box box-color box-bordered">
							<div class="box-title">
                                ...
                                <div class="pull-right">
                                	<a href="<?php echo $this->config->base_url('locations');?>" class="btn " rel="tooltip" title="Add New">Back to List </a>
                                </div>
							</div>
							<div class="box-content">
                                ...
                                <?php
									...
									echo form_open('/locations/add', $attributes);
								...
								?>
                                	...
                                	<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="location" id="location" class="input-xlarge" data-rule-required="true" data-rule-minlength="2" value="<?php echo $man->location_name; ?>">
										</div>
									</div>
