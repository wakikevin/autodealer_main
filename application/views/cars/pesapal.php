		...
		<div id="content">
			<div class="content">
				...
				<div class="main_wrapper">
					...
					<h1><strong></strong> Payment Details</h1>
					...
					*/
					$consumer_key = 'C0X/JoNloZPVXbezG/1SAk3fx17GmXZF';//Register a merchant account on
									   //demo.pesapal.com and use the merchant key for testing.
									   //When you are ready to go live make sure you change the key to the live account
									   //registered on www.pesapal.com!
					$consumer_secret = 'b7SBJfzOkTUeiTMny983YmZ9gVo=';// Use the secret from your test
					...
					//$callback_url = 'http://localhost/dc/cars/response'; //redirect url, the page that will handle the response from pesapal.
					$callback_url = 'http://www.greensoftkenya.com/autodealer/cars/response';
