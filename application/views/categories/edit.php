					...
					<div class="span12">
						<div class="box box-color box-bordered">
							<div class="box-title">
                                ...
                                <div class="pull-right">
                                	<a href="<?php echo $this->config->base_url('categories');?>" class="btn " rel="tooltip" title="Add New">Back to List </a>
                                </div>
							</div>
							<div class="box-content">
								...
								?>
                                	...
                                	<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="category_name" id="category_name" class="input-xlarge" data-rule-required="true" data-rule-minlength="2" value="<?php echo $man->category_name; ?>">
										</div>
									</div>
									...
									<div class="control-group">
										...
										<div class="controls">
											<select name="state" id="state" class="select2-me input-xlarge" data-rule-required="true">
