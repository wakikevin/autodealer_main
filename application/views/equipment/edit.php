			...
			<div class="container-fluid">
				...
				<div class="breadcrumbs">
					<ul>
						...
						<li>
							<a href="<?php echo $this->config->base_url('equipment');?>">Vehicle Equipment</a>
							<i class="icon-angle-right"></i>
						</li>
                        <li>
							<a href="">Add New</a>
					...
					<div class="span12">
						<div class="box box-color box-bordered">
							<div class="box-title">
                                ...
                                <div class="pull-right">
                                	<a href="<?php echo $this->config->base_url('equipment');?>" class="btn " rel="tooltip" title="Add New">Back to List </a>
                                </div>
							</div>
							<div class="box-content">
								...
								?>
                                	...
                                	<div class="control-group">
										<label for="textfield" class="control-label">Equipment Name</label>
										<div class="controls">
											<input type="text" name="equipment" id="equipment" class="input-xlarge" data-rule-required="true" data-rule-minlength="2" value="<?php echo $man->equipment_name; ?>">
										</div>
									</div>
